...
//           <p className="hsm-form-note">
//             Title, badge, and description are optional. You can save a slide with only an image.
//           </p>
...
//               onChange={handleChange}
//               placeholder="Badge / Highlight Text (optional)"
//               className="hsm-input"
//             />
//           </div>
...
const HeroSliderManager = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    // Ensure image is provided when creating a new slide
    if (!editingId && !form.image) {
      toast.error('Please select an image or video file for the slide');
      return;
    }
        ...
        <form onSubmit={handleSubmit} className="hsm-form">
          ...
          <div className="hsm-input-group">
            <input
              ...
              value={form.highlight}
              onChange={handleChange}
              placeholder="Badge / Highlight Text (optional, e.g. Save up to Rs. 500)"
              className="hsm-input"
            />
          </div>
              ...
              >
                ...
                <div className="hsm-card-body">
                  <header>
                    ...
                    {slide.title && <h3 className="hsm-card-title">{slide.title}</h3>}
                  </header>
